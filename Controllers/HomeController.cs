...
namespace FormsApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        //public IActionResult Create([Bind["Name,"Price"] Product model) böyle yaparsak sadece name ve price ı alır diğerlerini almaz 1.yol
        {
            ...
            if (imageFile != null) //önce null kontrolü yapılmalı
            {
                ...
                var path = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/images", randomFileName); //dosyanın kaydedileceği yer
        ...
        public IActionResult Edit(int? id) //url içinden id parametresini alırız.
        {
            if (id == null)
            {
                return NotFound();
        ...
        public IActionResult Delete(int? id) //url içinden id parametresini alırız 
        {
            if (id == null)
            {
                return NotFound();
